...
const verification={protocol:'neutron-wallet-dismissal-release-verification-v1',batchId:first.batch_id,postflightBatchId:second.batch_id,packages:preflight.packages.length,changed:[...changed],verifiedAt:new Date().toISOString(),allLocalBytesMatch:true};
