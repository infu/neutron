...
const previous = JSON.parse(await readFile(path.join(root,'.neutron/release-receipts/wallet-swap-ux-2026-09-06/preflight.json'),'utf8'));
const changed = new Set(['uniswap']);
