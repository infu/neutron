...
const previous = JSON.parse(await readFile(path.join(root,'.neutron/release-receipts/uniswap-agent-flow-2026-09-06/preflight.json'),'utf8'));
const changed = new Set(['kernel','agent','wallet','evm_wallet','uniswap']);
