...
export interface FeatureFlags { 'icrc152' : boolean, 'icrc2' : boolean }
...
export type Icrc152BurnError = { 'InvalidAccount' : string } |
  { 'GenericError' : { 'message' : string, 'error_code' : bigint } } |
  { 'Duplicate' : { 'duplicate_of' : bigint } } |
  { 'InsufficientBalance' : { 'balance' : bigint } } |
  { 'Unauthorized' : string };
export type Icrc152BurnResult = { 'Ok' : bigint } |
...
export type Icrc152MintError = { 'InvalidAccount' : string } |
  { 'GenericError' : { 'message' : string, 'error_code' : bigint } } |
  { 'Duplicate' : { 'duplicate_of' : bigint } } |
  { 'Unauthorized' : string };
export type Icrc152MintResult = { 'Ok' : bigint } |
