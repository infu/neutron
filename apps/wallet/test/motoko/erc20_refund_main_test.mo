    ...
    public func run() : async () {
        ...
        class Fixture() {
            ...
            public let env : Main.AppBackendEnvironment = {
                stable_memory = { wallet; wallet_transfers = transfers; wallet_commands = CommandMemory.init(); wallet_bridge = BridgeMemory.init(); wallet_bridge_provider = BridgeProviderMemory.init(); wallet_bridge_replacements = ReplacementMemory.init() };
