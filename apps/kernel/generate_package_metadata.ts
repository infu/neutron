...
export const KERNEL_NPL_RELEASE_VERSION = 356;
...
const KERNEL_REVIEWED_UNTRACKED_SOURCE_PATHS = new Set([
  ...
  "apps/kernel/src/consent/compact_permission_summary.ts",
  ...
  "apps/kernel/src/workspace/tool_contract.ts",
...
function assertKernelApplicationNotice(content: Uint8Array): void {
  ...
  for (const required of [
    ...
    "Package release: v0.3.56 (packed version 356)",
