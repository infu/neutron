...
function Library({ client, connected, connect, refresh, select, install, installing, explore }: { client: MarketplaceClient; connected: boolean; connect: () => void; refresh: number; select: (app: AppListing) => void; install: (ids: string[], quote: InstallationQuote) => void | Promise<void>; installing: boolean; explore: () => void }) {
