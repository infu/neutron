...
export function AppDetailDialog({ client, app, close, acquire, install, connected, connect, installing = false, discount = noDiscount, publisher }: {
  client: MarketplaceClient; app: AppListing; close: () => void; acquire: (app: AppListing) => void;
  install: (ids: string[], quote: InstallationQuote) => Promise<void> | void; connected: boolean; connect: () => Promise<unknown>; installing?: boolean; discount?: DiscountPreference; publisher: (id: string) => void;
}) {
