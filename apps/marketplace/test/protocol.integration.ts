...
import { CONTRACT, checkoutType, encodeOpaque, decodeOpaque, first, type Checkout, type Info, type WirePublisherProfile, type WireResult } from "../src/protocol.ts";
...
try {
  ...
  console.log("Marketplace client: real Candid, required publisher profiles, direct profile/listing queries, distinct-user and edited-review counters, exact attached cycle quotes, uploads and same-ID acquisition passed via Ash/PocketIC.");
