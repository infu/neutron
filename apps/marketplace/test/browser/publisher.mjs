...
try {
  ...
  for (const width of [320, 360, 480, 960]) {
    ...
    await page.getByRole("textbox", { name: "Full description", exact: true }).waitFor();
  ...
  await page.getByRole("textbox", { name: "Short description", exact: true }).fill("A journal in your workspace.");
  await page.getByRole("textbox", { name: "Full description", exact: true }).fill("Write private notes and organize your ideas.");
