...
module {
    ...
    public type AppBackendEnvironment = { stable_memory : { aave : Memory.Mem } };

    public class Init(env : AppBackendEnvironment) {
        let memory = env.stable_memory.aave;

        public func /*update*/aave_begin_v1(input : BeginV1) : ResultV1 {
        ...
        public func /*query*/aave_get_v1(id : Text) : ?OperationV1 {
            Map.get(memory.operations, Text.compare, id);
        };

        public func /*update*/aave_update_v1(input : UpdateV1) : ResultV1 {
        ...
        public func /*query*/aave_page_v1(input : PageInputV1) : PageResultV1 {
...
public type aave_begin_v1_Input = (input : BeginV1);
public type aave_begin_v1_Output = ResultV1;

public type aave_get_v1_Input = (id : Text);
public type aave_get_v1_Output = ?OperationV1;

public type aave_update_v1_Input = (input : UpdateV1);
public type aave_update_v1_Output = ResultV1;

public type aave_page_v1_Input = (input : PageInputV1);
public type aave_page_v1_Output = PageResultV1;
