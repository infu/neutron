...
const FINAL_KERNEL_CANDIDATE_ARCHIVE_PATH = fileURLToPath(
  new URL("../../../apps/kernel/kernel.v0.3.9.neutron", import.meta.url),
);
...
const CURRENT_PRODUCTION_APP_ARCHIVE_PATHS = [
  "../../../apps/agent/agent.v0.3.2.neutron",
  "../../../apps/chess/chess.v0.3.2.neutron",
  "../../../apps/contacts/contacts.v0.3.2.neutron",
  "../../../apps/gemma/gemma.v0.2.2.neutron",
  "../../../apps/hello/hello.v0.2.2.neutron",
  "../../../apps/hullshift/hullshift.v0.2.2.neutron",
  "../../../apps/jetcreeper/jetcreeper.v0.3.2.neutron",
  "../../../apps/kitchensink/kitchensink.v0.3.2.neutron",
  "../../../apps/mail/mail.v0.3.3.neutron",
  "../../../apps/mysubnet/mysubnet.v0.3.2.neutron",
  "../../../apps/spreadsheet/spreadsheet.v0.3.2.neutron",
  "../../../apps/vfs/files.v0.4.4.neutron",
  "../../../apps/wagyu/wagyu.v0.3.3.neutron",
  "../../../apps/wallet/wallet.v0.3.3.neutron",
...
function syntheticSuccessorKernelArchive(): Uint8Array {
  ...
  files["neutron.json"] = encoder.encode(
    JSON.stringify({ ...manifest, version: 309 }),
  );
...
test.skipIf(!RUN_CURRENT_RELEASE_ARTIFACT_GATE)(
  "release-only archived browser compilers compile the exact v0.3.9 candidate and current app archives in one batch",
  async () => {
    if (!HAS_CURRENT_RELEASE_ARTIFACTS) {
      throw new Error(
        "NEUTRON_RUN_LEGACY_CURRENT_ARCHIVE_GATE=1 requires the v0.3.7 predecessor, v0.3.9 candidate, and every current app archive",
      );
    }
