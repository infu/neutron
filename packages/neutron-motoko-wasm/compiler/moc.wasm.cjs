...
X(a){const
b=require("node:path"),c=b.join(__dirname,a);return require("node:fs/promises").readFile(c)}const
...
b=["E2BIG","EACCES","EAGAIN","EBADF","EBUSY","ECHILD","EDEADLK","EDOM","EEXIST","EFAULT","EFBIG","EINTR","EINVAL","EIO","EISDIR","EMFILE","EMLINK","ENAMETOOLONG","ENFILE","ENODEV","ENOENT","ENOEXEC","ENOLCK","ENOMEM","ENOSPC","ENOSYS","ENOTDIR","ENOTEMPTY","ENOTTY","ENXIO","EPERM","EPIPE","ERANGE","EROFS","ESPIPE","ESRCH","EXDEV","EWOULDBLOCK","EINPROGRESS","EALREADY","ENOTSOCK","EDESTADDRREQ","EMSGSIZE","EPROTOTYPE","ENOPROTOOPT","EPROTONOSUPPORT","ESOCKTNOSUPPORT","EOPNOTSUPP","EPFNOSUPPORT","EAFNOSUPPORT","EADDRINUSE","EADDRNOTAVAIL","ENETDOWN","ENETUNREACH","ENETRESET","ECONNABORTED","ECONNRESET","ENOBUFS","EISCONN","ENOTCONN","ESHUTDOWN","ETOOMANYREFS","ETIMEDOUT","ECONNREFUSED","EHOSTDOWN","EHOSTUNREACH","ELOOP","EOVERFLOW"];return{unix_error:b}}(globalThis))({"link":[["code-5bd095fd825b821c5e4a",0]],"generated":(a=>{var
c=a,b=a?.module?.export||a;return{"env":{"caml_unix_map_file_bytecode":()=>{throw new
Error("caml_unix_map_file_bytecode not implemented")}},"fragments":{"get_Array":a=>a.Array,"get_ArrayBuffer":a=>a.ArrayBuffer,"get_DataView":a=>a.DataView,"get_Date":a=>a.Date,"get_Error":a=>a.Error,"get_Float32Array":a=>a.Float32Array,"get_Float64Array":a=>a.Float64Array,"get_Int16Array":a=>a.Int16Array,"get_Int32Array":a=>a.Int32Array,"get_Int8Array":a=>a.Int8Array,"get_JSON":a=>a.JSON,"get_Math":a=>a.Math,"get_Object":a=>a.Object,"get_RegExp":a=>a.RegExp,"get_String":a=>a.String,"get_Uint16Array":a=>a.Uint16Array,"get_Uint32Array":a=>a.Uint32Array,"get_Uint8Array":a=>a.Uint8Array,"get_length":a=>a.length,"js_expr_12c48ca8":()=>a,"js_expr_21711c2a":()=>b,"js_expr_26f07992":()=>null,"js_expr_28647a4c":()=>!1,"js_expr_34e3f0a2":()=>Map,"meth_call_0_toString":a=>a.toString(),"meth_call_1_forEach":(a,b)=>a.forEach(b),"meth_call_2_set":(a,b,c)=>a.set(b,c),"meth_call_3_defineProperty":(a,b,c,d)=>a.defineProperty(b,c,d),"new_0":a=>new
a(),"new_1":(a,b)=>new
a(b),"obj_0":(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,A,B,C,D,E,F)=>({version:a,setProjectRoot:b,setExtraFlags:c,saveFile:d,removeFile:e,renameFile:f,readFile:g,readDir:h,addPackage:i,clearPackage:j,setCandidPath:k,setActorAliases:l,setPublicMetadata:m,setRunStepLimit:n,setTypecheckerCombineSrcs:o,setBlobImportPlaceholders:p,gcFlags:q,run:r,check:s,checkWithScopeCache:t,candid:u,stableCompatible:v,compileWasm:w,parseCandid:x,parseMotoko:y,parseMotokoWithDeps:z,inspectMotoko:A,parseMotokoTyped:B,parseMotokoTypedWithScopeCache:C,contextualDotSuggestions:D,contextualDotModule:E,printDeps:F}),"obj_1":(a,b)=>({value:a,enumerable:b}),"obj_10":(a,b)=>({diagnostics:a,code:b}),"obj_11":(a,b,c)=>({ast:a,immediateImports:b,scope:c}),"obj_12":(a,b)=>({diagnostics:a,code:b}),"obj_13":(a,b)=>({diagnostics:a,code:b}),"obj_14":(a,b)=>({ast:a,scope:b}),"obj_15":(a,b,c,d)=>({immediateImports:a,hasActorUrl:b,dotMembers:c,patternFields:d}),"obj_16":(a,b)=>({diagnostics:a,code:b}),"obj_17":(a,b)=>({diagnostics:a,code:b}),"obj_18":(a,b)=>({ast:a,immediateImports:b}),"obj_19":(a,b)=>({diagnostics:a,code:b}),"obj_2":(a,b)=>({name:a,args:b}),"obj_20":(a,b)=>({diagnostics:a,code:b}),"obj_21":(a,b)=>({diagnostics:a,code:b}),"obj_22":(a,b)=>({diagnostics:a,code:b}),"obj_23":(a,b)=>({diagnostics:a,code:b}),"obj_24":(a,b)=>({diagnostics:a,code:b}),"obj_25":(a,b,c)=>({wasm:a,candid:b,stable:c}),"obj_26":(a,b)=>({diagnostics:a,code:b}),"obj_27":(a,b)=>({diagnostics:a,code:b}),"obj_28":(a,b)=>({diagnostics:a,code:b}),"obj_29":(a,b)=>({diagnostics:a,code:b}),"obj_3":(a,b)=>({line:a,character:b}),"obj_30":(a,b)=>({diagnostics:a,code:b}),"obj_31":(a,b)=>({diagnostics:a,code:b}),"obj_32":(a,b)=>({diagnostics:a,scopeCache:b}),"obj_33":(a,b)=>({diagnostics:a,code:b}),"obj_34":(a,b)=>({diagnostics:a,code:b}),"obj_35":(a,b,c)=>({stdout:a,stderr:b,result:c}),"obj_36":a=>({error:a}),"obj_37":()=>({}),"obj_38":a=>({error:a}),"obj_4":(a,b)=>({start:a,end:b}),"obj_5":(a,b,c,d,e,f)=>({source:a,severity:b,range:c,code:d,category:e,message:f}),"obj_6":(a,b)=>({name:a,args:b}),"obj_7":(a,b)=>({moduleNameOrUri:a,funcName:b}),"obj_8":(a,b,c)=>({moduleUri:a,funcName:b,funcType:c}),"obj_9":(a,b)=>({diagnostics:a,code:b})}}})(globalThis),"src":"moc_wasm.bc.wasm.assets"});
