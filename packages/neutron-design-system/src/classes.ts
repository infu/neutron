...
export const nt = {
  ...
  appHeader: "nt-app-header",
  appHeaderMain: "nt-app-header-main",
  appHeaderIcon: "nt-app-header-icon",
  appHeaderCopy: "nt-app-header-copy",
  appHeaderTitle: "nt-app-header-title",
  appHeaderSubtitle: "nt-app-header-subtitle",
  appHeaderActions: "nt-app-header-actions",
  appHeaderControl: "nt-app-header-control",
  appHeaderIconButton: "nt-app-header-icon-button",
  appHeaderActionLabel: "nt-app-header-action-label",
  page: "nt-page",
