...
const TOKEN = "0x19A1c09fE3399C4Daaa2C98b936a8E460fC5Eaa4";
const SPENDER = "0x32c44758dc42A185b9aEFBE3d546a815e67b9E77";
const ORIGINAL_REQUEST = "96c08611f5ee53b7a37ef50090dd1011";
const ORIGINAL_HASH = "0x3c927a0a272ae2a936da836ad5d50e01a9948e405b40c7f9018d4fc5a1bba5d7";
...
test("recover the existing mined approval and revoke its allowance once through Wallet review", async ({ page }, testInfo) => {
  ...
  expect(nonceBefore).toEqual({ latest: "7", pending: "7" });
  ...
  expect(originalEvidence.nonce).toBe(6);
  ...
  try {
    ...
    expect(await nonces(chain)).toEqual({ latest: "8", pending: "8" });
